...
- [ ] `scripts/docs/gerar_05_regras_negocio.py` tem **só 14 linhas** (o código curto)
- [ ] `scripts/docs/templates/05_regras_negocio.md` existe
- [ ] `scripts/docs/_base.py` tem a função `gerar_de_template`
- [ ] A pasta `scripts/docs/templates/` existe
...
```powershell
cd C:\Users\gsilva\Documents\automacao-tickets
python scripts\docs\gerar_05_regras_negocio.py --forcar